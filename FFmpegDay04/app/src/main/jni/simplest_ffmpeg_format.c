...
JNIEXPORT jint JNICALL Java_com_leixiaohua1020_sffmpegandroidencoder_MainActivity_pkg
  (JNIEnv *env, jobject obj, jstring vUrl, jstring aUrl, jstring outUrl){
